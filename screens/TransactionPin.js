  ...
  if (loading) {
    return (
      <View style={[styles.loadingContainer, { backgroundColor: theme.background }]}>
        ...
        <Text style={[styles.loadingText, { color: theme.text }]}>Loading PIN settings...</Text>
      </View>
    )
  }
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      <View style={[styles.header, { backgroundColor: theme.primary }]}>
        ...
        <Text style={[styles.headerTitle, { color: theme.textContrast }]}>{hasPin ? "Change PIN" : "Create PIN"}</Text>
        <View style={styles.placeholder} />
      </View>
      ...
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={styles.keyboardAvoidingView}>
        ...
        >
          {/* Security Icon */}
          <View style={styles.iconSection}>
            <View style={[styles.iconContainer, { backgroundColor: theme.warningBackground }]}>
          ...
          <View style={styles.formContainer}>
            ...
            <View style={styles.inputContainer}>
              ...
              >
                ...
                />
                <TouchableOpacity onPress={() => setShowPin(!showPin)} style={styles.eyeButton}>
                  <Ionicons name={showPin ? "eye-off-outline" : "eye-outline"} size={20} color={theme.textSecondary} />
                </TouchableOpacity>
              </View>
            </View>
            ...
            >
              <Text style={[styles.requirementsTitle, { color: theme.textSecondary }]}>PIN Requirements:</Text>
              <View style={styles.requirement}>
                <Ionicons
                  name={pin.length >= 4 && pin.length <= 6 ? "checkmark-circle" : "ellipse-outline"}
                  size={16}
                  color={pin.length >= 4 && pin.length <= 6 ? theme.success : theme.textSecondary}
                />
                <Text
                  style={[
                    styles.requirementText,
                    { color: theme.textSecondary },
                    pin.length >= 4 && pin.length <= 6 && { color: theme.success },
                  ]}
                >
                  4-6 digits long
                </Text>
              ...
              <View style={styles.requirement}>
                <Ionicons
                  name={/^\d*$/.test(pin) && pin.length > 0 ? "checkmark-circle" : "ellipse-outline"}
                  size={16}
                  color={/^\d*$/.test(pin) && pin.length > 0 ? theme.success : theme.textSecondary}
                />
                <Text
                  style={[
                    styles.requirementText,
                    { color: theme.textSecondary },
                    /^\d*$/.test(pin) && pin.length > 0 && { color: theme.success },
                  ]}
                >
                  Numbers only
                </Text>
              ...
              <View style={styles.requirement}>
                <Ionicons
                  name={pin === confirmPin && pin.length > 0 ? "checkmark-circle" : "ellipse-outline"}
                  size={16}
                  color={pin === confirmPin && pin.length > 0 ? theme.success : theme.textSecondary}
                />
                <Text
                  style={[
                    styles.requirementText,
                    { color: theme.textSecondary },
                    pin === confirmPin && pin.length > 0 && { color: theme.success },
                  ]}
                >
                  PINs match
                </Text>
            ...
            >
              <LinearGradient colors={[theme.accent, theme.secondary]} style={styles.buttonGradient}>
                {saving ? (
                  ...
                  <>
                    <Text style={[styles.saveButtonText, { color: theme.textContrast }]}>
          ...
          <View style={styles.securityTips}>
            ...
            <View style={styles.tipItem}>
              ...
              <Text style={[styles.tipText, { color: theme.textSecondary }]}>Never share your PIN with anyone</Text>
            </View>
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
