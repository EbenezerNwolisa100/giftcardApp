      ...
      >
        ...
        <View style={styles.brandCard}>
          <View style={[styles.brandImageContainer, { backgroundColor: theme.surfaceSecondary }]}>
            <View style={{ width: 40, height: 40, backgroundColor: theme.surfaceSecondary, borderRadius: 8 }} />
          </View>
          <View style={styles.brandInfo}>
            <View style={{ width: 120, height: 20, backgroundColor: theme.surfaceSecondary, borderRadius: 4, marginBottom: 4 }} />
            <View style={{ width: 100, height: 16, backgroundColor: theme.surfaceSecondary, borderRadius: 4, marginBottom: 4 }} />
        ...
        <View style={styles.summaryContainer}>
          ...
          <View style={[styles.summaryCard, { backgroundColor: theme.surfaceSecondary }]}>
            ...
            <View style={styles.summaryRow}>
              <View style={{ width: 70, height: 16, backgroundColor: theme.surfaceSecondary, borderRadius: 4 }} />
              <View style={{ width: 40, height: 16, backgroundColor: theme.surfaceSecondary, borderRadius: 4 }} />
            </View>
            <View style={styles.summaryRow}>
              <View style={{ width: 50, height: 16, backgroundColor: theme.surfaceSecondary, borderRadius: 4 }} />
              <View style={{ width: 60, height: 16, backgroundColor: theme.surfaceSecondary, borderRadius: 4 }} />
            </View>
            <View style={[styles.summaryRow, styles.totalRow]}>
              <View style={{ width: 100, height: 18, backgroundColor: theme.surfaceSecondary, borderRadius: 4 }} />
              <View style={{ width: 120, height: 20, backgroundColor: theme.surfaceSecondary, borderRadius: 4 }} />
            </View>
          </View>
        </View>

        {/* Wallet Balance Display Skeleton */}
        <View style={[styles.walletContainer, { backgroundColor: theme.surfaceSecondary }]}>
          <View style={{ width: 100, height: 16, backgroundColor: theme.surfaceSecondary, borderRadius: 4, marginBottom: 8 }} />
          <View style={{ width: 120, height: 24, backgroundColor: theme.surfaceSecondary, borderRadius: 4, marginBottom: 4 }} />
          <View style={{ width: 80, height: 14, backgroundColor: theme.surfaceSecondary, borderRadius: 4 }} />
        </View>

        {/* Purchase/Fund Wallet Button Skeleton */}
        <View style={[styles.purchaseButton, { backgroundColor: theme.surfaceSecondary }]}>
